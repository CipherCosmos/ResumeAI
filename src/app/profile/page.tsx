                ...
                <CardContent>
                  <form onSubmit={handleProfileUpdate} className="space-y-4 max-w-xl">
                    <div className="flex items-center gap-6 mb-6">
                      <div className="h-24 w-24 rounded-full bg-muted flex items-center justify-center overflow-hidden border">
                        {image ? (
                          ...
                          <span className="text-3xl font-semibold text-muted-foreground">{name?.charAt(0) || email?.charAt(0) || 'U'}</span>
                        )}
                      </div>
                      <div className="space-y-2 flex-1">
                        <label className="text-sm font-medium leading-none mb-1 block">Avatar URL</label>
                        <Input type="url" value={image} onChange={e => setImage(e.target.value)} placeholder="https://example.com/avatar.jpg" />
                        <p className="text-xs text-muted-foreground">Provide a link to an image to use as your profile picture.</p>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        <label className="text-sm font-medium leading-none mb-1 block">Email address <span className="text-xs text-muted-foreground font-normal">(Read-only)</span></label>
                        <Input type="email" value={email} disabled className="bg-muted/50 text-muted-foreground" />
                      </div>
                      <div className="space-y-2">
                      ...
                      <div className="space-y-2">
                        <label className="text-sm font-medium leading-none mb-1 block">Address</label>
                        <Input type="text" value={address} onChange={e => setAddress(e.target.value)} placeholder="City, Country or Full Address" />
                      </div>
                    </div>
